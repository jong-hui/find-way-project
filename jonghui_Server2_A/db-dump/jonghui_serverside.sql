...
--
-- 데이터베이스: `kr_serverside`
--
CREATE DATABASE IF NOT EXISTS `kr_serverside` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
USE `kr_serverside`;
...
(1, '2018_11_09_004712_table_init', 1);
...
(1, 'Saadiyat Public Beach', 24.546990, 54.435870, 570, 169, 'saadiyat-public-beach.jpg', 'A meditative yoga session is what you need to find your inner calm with stroll along the white sandy shorelines Saadiyat Public Beach offers you a perfect setting for an everyday retreat'),
(2, 'Manarat Al Saadiyat', 24.533840, 54.418880, 517, 212, 'manarat-al-saadiyat.jpg', 'Manarat Al Saadiyat meanings the place of enlightenment is a purpose-built art and culture centre with multiple gallery spaces'),
(3, 'Ferrari World', 24.483230, 54.607430, 1103, 378, 'ferrari-world.jpg', 'Ferrari World Abu Dhabi was created in tribute to Ferrari passion heritage excellence innovation and performance'),
(4, 'Etihad Plaza', 24.443280, 54.608470, 1106, 509, 'etihad-plaza.jpg', 'Etihad Plaza is a development of 789 residential units in Khalifa City featuring comprehensive lifestyle amenities including 4973 square metres of retail and 4'),
(5, 'Abu Dhabi International Airport', 24.441930, 54.650070, 1236, 513, 'abu-dhabi-international-airport.jpg', 'The construction of the Midfield Terminal Complex (MTC) and overall expansion of Abu Dhabi International Airport are vital to enable the diversification of the Emirate economy'),
(6, 'Zayed University', 24.393650, 54.584280, 1031, 671, 'zayed-university.jpg', 'Zayed University is a national and regional leader in educational innovation. Founded in 1998 and proudly bearing the name of the Founder of the Nation'),
(7, 'Sheikh Zayed Grand Mosque', 24.412540, 54.475140, 692, 609, 'sheikh-zayed-grand-mosque.jpg', 'Sheikh Zayed Grand Mosque is located in Abu Dhabi  the capital city of the United Arab Emirates  and is considered to be the key site for worship in the country'),
(8, 'Mangrove National Park', 24.456060, 54.417800, 514, 467, 'mangrove-national-park.jpg', 'Most often found growing in the sea waters of tropical and sub-tropical coastal areas. This hardy tree acts as a natural windbreak.'),
(9, 'Al Ghaf Park', 24.435390, 54.410270, 491, 534, 'al-ghaf-park.jpg', 'The low-rise residential towers which feature a range of studio one two and three-bedroom apartments are the ideal location for professionals and small families'),
(10, 'Umm Al Emarat Park', 24.453070, 54.380800, 399, 477, 'umm-al-emarat-park.jpg', 'Umm Al Emarat Park was first opened to visitors in 1982. It is one of the oldest and largest urban parks in Abu Dhabi centrally located on 15th Street between Airport Road and Karamah Street'),
(11, 'Electra Park', 24.496590, 54.376450, 386, 334, 'electra-park.jpg', 'Abu Dhabi has more than 2000 well-maintained parks and gardens. Electra park is one of the main parks in Abudhabi situated near by corniche'),
(12, 'Qasr Al Hosn', 24.482230, 54.354720, 318, 381, 'qasr-al-hosn.jpg', 'It remained the emir`s palace and seat of government until 1966.'),
(13, 'Emirates Palace', 24.461580, 54.317400, 202, 449, 'emirates-palace.jpg', 'The Emirates Palace is a luxury hotel in Abu Dhabi. United Arab Emirates operated by Kempinski and opened in February 2005.');
...
CREATE TABLE `schedules` (
  `id` int(10) UNSIGNED NOT NULL,
  `type` enum('TRAIN','BUS') COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `users` (`id`, `username`, `password`, `token`, `remember_token`) VALUES
(1, 'admin', '$2y$10$FEOodE1ewZ9z0jBb0X3muuLBUGp.g1wZo4wIpft77Dw5bnXCoETtS', '', '21232f297a57a5a743894a0e4a801fc3'),
(2, 'user1', '$2y$10$wWFfPTxLGevlYwPfQVxunuUKRDFXZPrSHkA8PhVuBwAe2BOp6wPRe', '', '24c9e15e52afc47c225b757e7bee1f9d'),
(3, 'user2', '$2y$10$mxbDgWPTZfeRaAMDvdk9kO2mxNk9lSKsTjIqkqzDPVjqVnuxlP/5O', '', '7e58d63b60197ceb55a1c487989a3720');
...
--
ALTER TABLE `histories`
  ADD CONSTRAINT `histories_place_id_foreign` FOREIGN KEY (`place_id`) REFERENCES `places` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `schedules`
  ADD CONSTRAINT `schedules_from_place_id_foreign` FOREIGN KEY (`from_place_id`) REFERENCES `places` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `schedules_to_place_id_foreign` FOREIGN KEY (`to_place_id`) REFERENCES `places` (`id`) ON DELETE CASCADE;
COMMIT;
